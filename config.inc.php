...
# Общие настройки
$config							= array();
$config['sitelink']				= 'http://aidan-express.kg/'; # URL сайта, со слэшем на конце
$config['sitename']				= 'Aidan-Express'; # Заголовок сайта
$config['slogan']				= '<a href="/index.html"><img src="/i/aidan-express.png" alt="Айдан-экспресс" style="height:100px;"></a>
									УДОБНО, НАДЕЖНО И В СРОК &thinsp;'; # Слоган
